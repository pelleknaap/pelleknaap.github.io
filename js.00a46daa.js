...
},{}],"js/fa.js":[function(require,module,exports) {
/*!
...
!function () {
  ...
  var e = (l.navigator || {}).userAgent,
      ...
      t = z,
      M = !!a.document,
      r = !!f.documentElement && !!f.head && "function" == typeof f.addEventListener && "function" == typeof f.createElement,
  ...
  var N = a || {};
  N[H] || (N[H] = {}), N[H].styles || (N[H].styles = {}), N[H].hooks || (N[H].hooks = {}), N[H].shims || (N[H].shims = []);

  var E = N[H],
      P = [],
      _ = !1;

  r && ((_ = (f.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(f.readyState)) || f.addEventListener("DOMContentLoaded", function c() {
  ...
  function hc(c) {
    var l = c.icons,
        ...
        V = [O.replacementClass, e ? O.familyPrefix + "-" + e : "", n].concat(t.classes).join(" "),
        o = {
      children: [],
    ...
    M && (o.attributes[g] = ""), s && o.children.push({
      tag: "title",
      attributes: {
  ...
  function vc(c) {
    ...
    G(z) && (L.transform = (M = (f = {
      ...
      width: h,
      height: v
    }).transform, r = f.width, H = void 0 === r ? b : r, i = f.height, n = void 0 === i ? b : i, V = f.startCentered, C = "", C += (o = void 0 !== V && V) && p ? "translate(" + (M.x / F - H / 2) + "em, " + (M.y / F - n / 2) + "em) " : o ? "translate(calc(-50% + " + M.x / F + "em), calc(-50% + " + M.y / F + "em)) " : "translate(" + M.x / F + "em, " + M.y / F + "em) ", C += "scale(" + M.size / F * (M.flipX ? -1 : 1) + ", " + M.size / F * (M.flipY ? -1 : 1) + ") ", C += "rotate(" + M.rotate + "deg) "), L["-webkit-transform"] = L.transform);
    var u = K(L);
  ...
  var zc = function zc() {},
    ...
    var z,
        ...
        t = Object.keys(c),
        f = t.length,
        M = void 0 !== v ? (a = l, s = v, function (c, l, h, v) {
  ...
  var kc = function kc(c) {
    var l,
        ...
        s = Cc(X(c));
    return e && m && (s.prefix = e, s.iconName = m), s.prefix && 1 < a.length ? s.iconName = (v = s.prefix, z = c.innerText, Hc[v][z]) : s.prefix && 1 === a.length && (s.iconName = (l = s.prefix, h = function (c) {
  ...
  function Xc(c) {
    var l,
        ...
        C,
        L,
        u = (h = kc(l = c), v = h.iconName, z = h.prefix, e = h.rest, m = Sc(l), a = Ac(l), s = qc(l), t = Oc(l), f = jc(l), {
      iconName: v,
    ...
    }(c, u) : (M = c, H = (r = u).iconName, i = r.title, n = r.prefix, V = r.transform, o = r.symbol, C = r.mask, L = r.extra, [M, hc({
      icons: {
        main: Dc(H, n),
      ...
      wc = !0, function () {
        D(c.querySelectorAll("*")).forEach(function (m) {
          [":before", ":after"].forEach(function (l) {
            ...
            if (v && (v.nextSibling && -1 < v.nextSibling.textContent.indexOf(n) && Yc(v.nextSibling), Yc(v), v = null), h && !v) {
              var z = c.getPropertyValue("content"),
                  e = f.createElement("i");
              e.setAttribute("class", "" + Bc[h[1]]), e.setAttribute(n, l), e.innerText = 3 === z.length ? z.substr(1, 1) : z, ":before" === l ? m.insertBefore(e, m.firstChild) : m.appendChild(e);
            }
          });
        });
      }(), wc = !1, l();
    ...
    if (r) {
      var h = f.documentElement.classList,
        ...
        return h.remove(V + "-" + c);
          ...
          e = Object.keys(Ic),
          m = ["." + Rc + ":not([" + g + "])"].concat(e.map(function (c) {
        return "." + c + ":not([" + g + "])";
      })).join(", ");
  ...
  var Qc = function () {
    ...
    return y(c, [{
      key: "add",
      value: function value() {
        for (var l = this, c = arguments.length, h = Array(c), v = 0; v < c; v++) {
          h[v] = arguments[v];
        }
        ...
        Object.keys(z).forEach(function (c) {
          l.definitions[c] = S({}, l.definitions[c] || {}, z[c]), function c(l, v) {
            ...
            "function" == typeof E.hooks.addPack ? E.hooks.addPack(l, h) : E.styles[l] = S({}, E.styles[l] || {}, h), "fas" === l && c("fa", v);
          }(c, z[c]);
        });
      }
    }, {
  ...
  var vl,
    ...
    if (c) {
      ...
      return ll(S({
        ...
        return cl(), O.autoA11y && (t ? H["aria-labelledby"] = O.replacementClass + "-title-" + B() : H["aria-hidden"] = "true"), hc({
          icons: {
            main: Zc(C),
            mask: a ? Zc(a.icon) : {
              found: !1,
  ...
  Object.defineProperty(ml, "config", {
    ...
    M && (a.FontAwesome || (a.FontAwesome = ml), T(function () {
      0 < Object.keys(E.styles).length && al(), O.observeMutations && "function" == typeof MutationObserver && function (c) {
        if (s) {
          ...
          yc = new s(function (c) {
            wc || D(c).forEach(function (c) {
              if ("childList" === c.type && 0 < c.addedNodes.length && !pc(c.addedNodes[0]) && (O.searchPseudoElements && m(c.target), z(c.target)), "attributes" === c.type && c.target.parentNode && O.searchPseudoElements && m(c.target.parentNode), "attributes" === c.type && pc(c.target) && ~u.indexOf(c.attributeName)) if ("class" === c.attributeName) {
                var l = Cc(X(c.target)),
                    h = l.prefix,
                    v = l.iconName;
          ...
          }), r && yc.observe(f.getElementsByTagName("body")[0], {
            childList: !0,
            attributes: !0,
            characterData: !0,
            subtree: !0
...
},{}],"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"css/tiny-slider.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/fa.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/aos.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"sass/main.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\assets\\fonts\\Rubik-Regular.ttf":[["Rubik-Regular.66042536.ttf","assets/fonts/Rubik-Regular.ttf"],"assets/fonts/Rubik-Regular.ttf"],"./..\\assets\\fonts\\Rubik-Light.ttf":[["Rubik-Light.642acd26.ttf","assets/fonts/Rubik-Light.ttf"],"assets/fonts/Rubik-Light.ttf"],"./..\\assets\\img\\stripes-light.png":[["stripes-light.c67a30a8.png","assets/img/stripes-light.png"],"assets/img/stripes-light.png"],"./..\\assets\\img\\leaves-pattern.png":[["leaves-pattern.8ffbc637.png","assets/img/leaves-pattern.png"],"assets/img/leaves-pattern.png"],"_css_loader":"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/index.js":[function(require,module,exports) {
"use strict";

require("/css/tiny-slider.css");
...
var fa = require('/js/fa.js');

var anime = require('/js/anime.min.js');

var scroll = require("/js/smooth-scroll.polyfills.min.js"); // const svg = require("/js/svg-injector.min.js");
// const svg_inject = require("/js/svg-injector.min.js");
// const lozad = require('/js/lozad.min.js');
// const tns = require("/js/tiny-slider.js");
...
if (document.getElementById("home")) {
  ...
  page = "contact";
} // injecting all the SVGs into the code


var mySVGsToInject = document.querySelectorAll('img.inject-me');
SVGInjector(mySVGsToInject); // adding smooth scrolls to all links

var smooth_scroll = new scroll('a[href*="#"]', {
  speed: 750
}); // initing AOS
...
AOS.init({
  duration: 1500,
  offset: 200
}); // setting home page specfic things, like the testimonials slider and title animation

if (page == "home") {
  var lineDrawing = anime({
    targets: '.heading-primary__main-svg path',
...
if (page == "contact") {
  var next = function next() {
    console.log("lol");
    var translate = "-" + current_tab + "00vw";
  ...
  var previous = function previous() {
    ...
    console.log(current_tab - 2);
    var translate = "-" + (current_tab - 2) + "00vw";
    el.style.transform = "translateX(" + translate + ")";
    current_tab--;
  };

  var current_tab = 1;
  var el = document.querySelector('.contact__form');
  document.querySelectorAll(".contact__next").forEach(function (elem) {
    console.log("yeet");
    elem.addEventListener("click", function () {
      next();
    });
  });
  document.querySelectorAll(".contact__previous").forEach(function (elem) {
    console.log("yeet");
    elem.addEventListener("click", function () {
      previous();
    });
...
},{"/js/aos.js":"js/aos.js","/js/fa.js":"js/fa.js","/js/anime.min.js":"js/anime.min.js","/js/smooth-scroll.polyfills.min.js":"js/smooth-scroll.polyfills.min.js","/css/tiny-slider.css":"css/tiny-slider.css","/css/fa.css":"css/fa.css","/css/aos.css":"css/aos.css","../sass/main.scss":"sass/main.scss"}],"C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/pelle/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
